...
if aggregate
    ...
    o2 = File.open("predicting_step#{step}_norm#{normalize}_dv#{topredict}#{intersection}_#{function}_error_joint_bundle.tsv","w:utf-8")
    o3 = File.open("predicting_step#{step}_norm#{normalize}_dv#{topredict}#{intersection}_#{function}_error_joint_categorical.tsv","w:utf-8")
