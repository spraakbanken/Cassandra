...
o.puts "verb\ttotal\tv1\tv2\ttotal_2009\tv1_2009\tv2_2009\tv1rel_2009\tv2rel_2009"
...
#=begin
            ...
            o.puts "#{verb}\t#{v1+v2}\t#{v1}\t#{v2}\t#{v12009 + v22009}\t#{v12009}\t#{v22009}\t#{v12009.to_f/(v12009 + v22009)}\t#{v22009.to_f/(v12009 + v22009)}"
